...
export interface ApiNewsArticleNewsArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    tag: Schema.Attribute.Component<'news.tag', true>;
...
export interface ApiProjectInquiryProjectInquiry
  ...
  info: {
    displayName: 'Project Inquiry';
    pluralName: 'project-inquiries';
    singularName: 'project-inquiry';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    agree_privacy: Schema.Attribute.Boolean;
    ...
    project_url: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
